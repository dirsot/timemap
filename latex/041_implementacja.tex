...
Zgodnie z wnioskami omówionymi w sekcji \ref{subsec:fileformat} do przechowywania danych wykorzystano format GML. Wykorzystanie pliku teksto pozwala na swobodne tworzenie i edycję plików wejsciowych. W celu odczytu  danych z pliku i zapisu ich w pamięci sesyjnech przęglądarki(Storage) stworzona została klasa FileParser. Posiada ona jednoargumentowy konstruktor przyjmujący ciąg znakowy będący zawartośćią pliku.
